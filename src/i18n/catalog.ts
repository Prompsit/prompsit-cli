...
export const STRINGS = {
  ...
  "auth.device.url_copied": "Sign-in URL copied to clipboard.",
  "auth.device.url_sent_osc52": "Sign-in URL sent to terminal clipboard (OSC 52).",
  "auth.device.url_copy_unavailable": "Could not copy sign-in URL; copy it manually.",
