...
| **Dependencies** | `prompt-toolkit` + `rich` (2 packages, both mature) | `ink` + `react` + `@inkjs/ui` (3 packages, JSX transform required) | `@earendil-works/pi-tui` (1 package, plain TypeScript) |
